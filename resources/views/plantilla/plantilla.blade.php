...
<head>
    ...
    <meta name="description" content="Biofoods Shop template">
...
<body>
    ...
    <div id="app">
        ...
        <div class="menu">
            ...
            <div class="menu_nav">
                <ul>
                    <li><a href="#">Panetones y Postres</a></li>
                ...
                <div class="header_content d-flex flex-row align-items-center justify-content-start">
                    ...
                    <nav class="main_nav">
                        <ul class="d-flex flex-row align-items-start justify-content-start">
                            <li class="active"><a href="#">Panetones y Postres</a></li>
                            <li><a href="#">Insumos</a></li>
                            <li><a href="#">Light</a></li>
                        </ul>
                    </nav>
                    <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                        ...
                        <div class="cart">
                            <a href="cart.html">
                                <div>
                                    <img class="svg" src="http://127.0.0.1:8000/asset/images/cart.svg" alt="https://www.flaticon.com/authors/freepik">
                                    <div>
                                        1
                                    </div>
                                </div>
                        ...
                        <div class="header_phone d-flex flex-row align-items-center justify-content-start">
                            <div>
                                <div>
                                    <img src="http://127.0.0.1:8000/asset/images/phone.svg" alt="https://www.flaticon.com/authors/freepik">
                                </div>
                            </div>
                            <div>+51 987-654-123</div>
                        </div>
                                        ...
                                        <a href="#">
                                            <div class="d-flex flex-row align-items-center justify-content-start">
                                                <div class="footer_logo_icon">
                                                    <img src="http://127.0.0.1:8000/asset/images/logo_2.png" alt="">
                                                </div>
                                                <div>Biofoods Shop</div>
                                            </div>
                                        </a>
                                ...
                                <div class="footer_bar_content d-flex flex-md-row flex-column align-items-center justify-content-start">
                                    ...
                                    <nav class="footer_nav ml-md-auto order-md-2 order-1">
                                        <ul class="d-flex flex-row align-items-center justify-content-start">
                                            <li><a href="category.html">Panetones y Postres</a></li>
                                            <li><a href="category.html">Insumos</a></li>
                                            <li><a href="category.html">Light</a></li>
